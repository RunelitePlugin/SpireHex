...
interface BuildScript {
  ...
  /** Per-script lock floor — the biome-5 spine fields the earned Storm Pylon. */
  minLives: number;
}

const SCRIPTS: BuildScript[] = [
  { levelId: 'level42', specId: 'stormTempestCoil', build: [
    { typeId: 'stormPylon', hex: offsetToAxial(7, 5) },     // the tower earned at level40 IS the spine
    { typeId: 'boulderMortar', hex: offsetToAxial(5, 5) },
    { typeId: 'watchSentry', hex: offsetToAxial(10, 4) },
  ], minLives: 18 },                                          // measured: spec @ wave 3/7, won 20/20
];
...
describe('P13 Radiant economy acceptance (biome-legal pool)', () => {
