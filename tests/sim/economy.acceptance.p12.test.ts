...
interface BuildScript {
  ...
  /** Per-script lock floor — biome-2 (emberSpire) and biome-3 (frostObelisk) margins differ. */
  minLives: number;
}

const SCRIPTS: BuildScript[] = [
  { levelId: 'level12', specId: 'emberMeteorCaller', build: [
    { typeId: 'emberSpire', hex: offsetToAxial(6, 5) },     // the earned tower IS the spine
    { typeId: 'boulderMortar', hex: offsetToAxial(4, 5) },
    { typeId: 'watchSentry', hex: offsetToAxial(9, 4) },
  ], minLives: 18 },                                          // measured: spec @ wave 5/7, won 20/20
  { levelId: 'level22', specId: 'frostDeepFreeze', build: [
    { typeId: 'frostObelisk', hex: offsetToAxial(7, 5) },   // the freshly earned tower IS the spine
    { typeId: 'boulderMortar', hex: offsetToAxial(5, 5) },
    { typeId: 'watchSentry', hex: offsetToAxial(10, 3) },
  ], minLives: 16 },                                          // measured: spec @ wave 3/7, won 19/20
];
...
describe('P12 economy acceptance (biome-legal pools)', () => {
