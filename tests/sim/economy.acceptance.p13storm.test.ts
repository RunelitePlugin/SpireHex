...
interface BuildScript {
  ...
  /** Per-script lock floor — the biome-4 spine fields the earned Thorn Totem. */
  minLives: number;
}

const SCRIPTS: BuildScript[] = [
  { levelId: 'level32', specId: 'thornPlaguebearer', build: [
    { typeId: 'thornTotem', hex: offsetToAxial(5, 3) },     // the tower earned at level30 IS the spine
...
describe('P13 Storm economy acceptance (biome-legal pool)', () => {
